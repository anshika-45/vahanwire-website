import{r as a,j as e,R as v}from"./index-CwN6xw2H.js";import{S as b}from"./images-ErPs11Bh.js";function w({texts:t=[],interval:l=1600,outMs:c=360,inMs:x=560,className:o=""}){const[s,f]=a.useState(0),[n,r]=a.useState("idle"),[d,u]=a.useState(1),i=a.useRef(null);if(!t||t.length===0)return null;if(t.length===1)return e.jsx("div",{className:`relative overflow-visible h-20 sm:h-24 md:h-26 ${o}`,style:{lineHeight:1.2,display:"flex",alignItems:"center",paddingBottom:"8px"},children:e.jsx("span",{className:`absolute inset-0 flex items-start text-5xl sm:text-7xl md:text-8xl font-medium tracking-tight
