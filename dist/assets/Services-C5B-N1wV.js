import{R as a,u as p,r as g,j as e}from"./index-FS6cpKeu.js";const o=a.memo(function({icon:t,title:n,desc:l,linkText:i,linkHref:c="/"}){const d=p(),[m,r]=g.useState(!1),x=()=>{d(c),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs("button",{className:`tile ${m?"hovered":""} 
