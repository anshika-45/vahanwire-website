  ...
  return (
    <div className="duration-300 ease-in transition-all lg:pb-7 pb-20 xl:mb-0 mb-10">
      ...
      <div className="container">
        <div className="flex flex-col items-center justify-center px-3 sm:px-4 md:px-6 pt-4 sm:pt-8 md:pt-12 pb-8 md:pb-16">
          <div className="relative w-full max-w-5xl mx-auto">
            <div className="lg:grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-10 lg:gap-16 items-center flex flex-col-reverse">
              <div className="relative text-center lg:text-left">
                ...
                <p className="text-base sm:text-lg md:text-xl font-semibold mb-4 md:mb-6">
