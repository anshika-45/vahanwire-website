    ...
    return (
        <section className="bg-[#FAFCFF]">
            <div className="max-w-5xl mx-auto grid md:grid-cols-2 items-center gap-8">
                <div className="flex justify-center mr-8 order-1 md:order-2">
            <img loading="lazy"
            src={appImage}
            alt="VahanWire App"
            className="w-[600px] md:w-[650px] lg:w-[700px] drop-shadow-2xl h-full rounded-[2rem] scale-160"
            />
            </div>
            <div className="bg-white rounded-2xl border border-[#BCD2F5] p-2 sm:p-4 md:p-6 lg:p-8 space-y-8 max-w-md sm:ml-15 text-left order-2 md:order-1">
            <div>
            <h2 className="text-xl md:text-2xl text-skyblue-200 mb-7 text-center font-semibold">
            ...
            "All-in-one platform for vehicle services, fuel, towing, and payments",
                "Verified mechanics and trusted service centers",
                    ...
                    <img loading="lazy" src={checkIcon} alt="check" className="w-6 h-6 flex-shrink-0 mt-1" />
            ...
            <div>
            <p className="font-semibold text-sm mb-4 text-left">Download App Now</p>
            <div className="flex gap-2 justify-start">
            <img loading="lazy"
            src={Applogo}
                alt="App Store"
                    className="h-10 sm:h-8 md:h-12 lg:h-14 cursor-pointer"
                            />
                    <img loading="lazy"
                    src={Playlogo}
                alt="Google Play"
