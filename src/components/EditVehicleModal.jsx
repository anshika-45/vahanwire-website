          ...
          >
            ...
            <div>
              ...
              <input 
                ...
                className="w-full h-8 sm:h-9 border border-slate-300 rounded-lg px-3 text-xs sm:text-sm text-gray-900 placeholder:text-gray-400 placeholder:text-xs focus:ring-2 focus:ring-[#D9E7FE] outline-none"
            ...
            <div>
              ...
              <input 
                ...
                className="w-full h-8 sm:h-9 border border-slate-300 rounded-lg px-3 text-xs sm:text-sm text-gray-900 placeholder:text-xs placeholder:text-gray-400 focus:ring-2 focus:ring-[#D9E7FE] outline-none"
              />
            </div>
            <div>
