...
const TermsCondition = () => {
  const sections = [
    ...
    },
    {
      ...
      content: [
        "Sending a request in through email at support@vahanwire.com or calling 01203221368 signed with electronic signature identifying the content alleged to be in infringement of your rights as the rightful owner or affecting you prejudicially; providing your contact information including email, address, and telephone number where you can be contacted if required.",
      ],
    },
    // {
